...
(async () => {
    try {
        ...
        logger(global.getText('alikhan', 'successConnectDatabase'), '[ DATABASE ]');
        const botData = {};
        botData.models = models
        onBot(botData);
    } catch (error) { logger(global.getText('alikhan', 'successConnectDatabase', JSON.stringify(error)), '[ DATABASE ]'); }
})();
